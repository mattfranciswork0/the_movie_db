...
module.exports = {
  ...
  output: {
    filename: 'bundle.js',
    path: path.resolve(__dirname, 'dist') // dirname (reserved keyword)= current directory; create a path
  ...
  plugins: [ // not in reversed order like use[]
    ...
    // will create a viewable html file (bundle.js automaticly creates the html part but we don't see it without this)
    ...
    // pass in the folders that you want to clean
  ]
};
